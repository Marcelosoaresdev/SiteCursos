      ...
      <div className="container mx-auto text-center max-w-3xl">
        ...
        <ul className="space-y-4 text-left font-ttnorms text-xl list-disc pl-6 mb-12">
          {data.items.map((item, index) => (
            <li key={index} dangerouslySetInnerHTML={{ __html: item.replace("BÔNUS:", "<strong>BÔNUS:</strong>") }}></li>
          ))}
        </ul>
        ...
        <div className="font-ttnorms">
            <p className="text-xl line-through opacity-80">De {data.price.original} por</p>
